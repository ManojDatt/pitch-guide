...
def get_vocal_file(options):
    ...
    #     'mus_output_file': None,
    #     'pitch_output_file': None,
    ...
    if inputAudioFile[-4:] != ".wav":
        ...
        sound = AudioSegment.from_mp3(os.path.join(os.getcwd(), inputAudioFile))
        sound.export("{}.wav".format(inputAudioFile.split('.')[0].replace(" ", "-")), format="wav")
        inputAudioFile = "{}.wav".format(inputAudioFile.split('.')[0].replace(" ", "-"))
